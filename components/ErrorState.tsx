...
export default function ErrorState({
  ...
  description = "We couldn’t load this page. It may be a temporary connection or server issue — try again in a moment.",
  digest,
  onRetry,
}: ErrorStateProps) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        /* keep empty — error page should still render */
      }
    })();
    return () => {
      cancelled = true;
    ...
    <main className="relative flex flex-1 overflow-hidden bg-[radial-gradient(ellipse_at_top,var(--theme-soft)_0%,var(--theme-surface)_55%)]">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 py-16 md:px-10 md:py-24">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          {digest ? (
            <p className="mt-3 font-mono text-[12px] text-[#1a1a1a]/40">
              Ref: {digest}
            </p>
          ) : null}
